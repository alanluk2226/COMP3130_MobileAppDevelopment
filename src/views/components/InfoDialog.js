        ...
        <View style={styles.dialogContainer}>
          <ScrollView
            ...
            <View style={styles.titleSection}>
              <Text style={styles.schoolName}>{school.nameEn}</Text>
              <Text style={styles.schoolNameCh}>{school.nameCh}</Text>
            </View>
            ...
            <View style={styles.infoSection}>
              <InfoItem icon="📍" label="District" value={school.district} />
              <Divider />
              <InfoItem icon="☎️" label="Phone" value={school.phone} />
              <Divider />
              <InfoItem icon="📬" label="Address" value={school.address} />
